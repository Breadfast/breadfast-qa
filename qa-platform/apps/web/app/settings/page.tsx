...
const CATALOG: Array<{ group: string; title: string; fields: FieldDef[] }> = [
  ...
  { group: 'ai', title: 'AI', fields: [
    ...
    { key: 'ai.knowledgeBasePath', label: 'Knowledge base path', placeholder: 'D:\\BreadfastQA' },
  ]},
  { group: 'automation', title: 'Automation', fields: [
    { key: 'automation.playwrightPath', label: 'Playwright framework path', placeholder: 'D:\\Playwright\\b55168_pom' },
    { key: 'automation.appiumPath', label: 'Appium framework path', placeholder: 'D:\\projects' },
