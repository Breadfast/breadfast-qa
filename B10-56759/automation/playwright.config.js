...
/**
 * B10-56759 — self-contained Playwright project (Perk Details lifecycle
 * management: header Delete/Edit buttons + status/type-aware edit mode).
 *
 ...
 *   - Dependencies (@playwright/test, …) are installed ONCE at the repo root
 *     D:\breadfast-qa\node_modules; Node resolves them by walking up the tree.
 *
 * Run:  cd D:\breadfast-qa\B10-56759\automation  &&  npx playwright test
 */
