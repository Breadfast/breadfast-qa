...
/**
 * B10-56729 — self-contained Playwright project.
 *
 * Architecture (per "each story owns its architecture"):
 *   - This story runs on its OWN config + ./tests, independent of any other story
 *     and of the retired D:\Playwright\b55168_pom copy.
 ...
 *
 * Run:  cd D:\breadfast-qa\B10-56729\automation  &&  npx playwright test
 */
