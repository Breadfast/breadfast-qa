...
/**
 * B10-57393 — compare the Selenium (Java/TestNG) and Playwright suites on the SAME 22 BrowserStack
 * cases, from each runner's machine-readable output rather than by eyeballing logs.
 *
 *   Selenium  : D:/projects/target/surefire-reports/testng-results.xml
 *   Playwright: ../execution-reports/playwright-results.json
 *
 ...
 *
 * Usage: node compare_stacks.js [--md]
 */
const fs = require('fs');
const path = require('path');

const TESTNG_XML = 'D:/projects/target/surefire-reports/testng-results.xml';
const PW_JSON = path.resolve(__dirname, '..', 'execution-reports', 'playwright-results.json');
...
fs.writeFileSync(path.resolve(__dirname, '..', 'execution-reports', 'stack-comparison.json'),
