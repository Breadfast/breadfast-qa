 ...
 * capturing evidence at every step. This is the reusable path every B10-56652 scenario starts from.
 *
...
async function run(platform, locale, phone) {
  ...
  await dump(sid, tag, '04-pay-gate');
...
if (require.main === module) {
  const [platform = 'android', locale = 'en', phone = '1189586349'] = process.argv.slice(2);
