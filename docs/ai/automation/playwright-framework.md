...
- **Naming:** PascalCase page/helper files; `snake_case.spec.js` specs; `snake_case.js` runners; camelCase verb-first methods; `get<Thing>()` config getters; UPPER_SNAKE module constants; every test title tagged with its case id `[TC_...]`.
