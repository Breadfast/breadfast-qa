'use strict';
/**
 * B10-56717 — upload the generated test cases into BrowserStack Test Management.
 *
...
const FOLDER = arg('--folder', '53347724');
...
function payload(c) {
  return {
    test_case: {
      ...
      priority: c.priority,
      tags: ['ai-created', 'B10-56717', ...(c.locale ? [`locale-${c.locale}`] : [])],
      issues: [ISSUES],
